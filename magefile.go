...
const (
	binaryName   = "import-fred"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/import-fred/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/import-fred/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/import-fred/common.buildDate=$BUILD_DATE"
...
var (
	pkgPrefixLen = len("github.com/penny-vault/import-fred")
	pkgs         []string
	pkgsInit     sync.Once
)
